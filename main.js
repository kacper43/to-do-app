...
function fetchIssues(){
  ...
  for (var i = 0; i < issues.length; i++) {
    ...
    issuesList.innerHTML += '<div class="well">'+
                            ...
                            '<a href="#" onclick="setStatusClosed(\''+id+'\')" class="btn btn-warning">Zamknij problem</a>'+
                            '<a href="#" onclick="deleteIssue(\''+id+'\')" class="btn btn-danger">Usuń problem</a>'+
                            '</div>';
  }
}
